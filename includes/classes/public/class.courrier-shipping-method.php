...
if(!class_exists('WC_LP_Express_Courrier_Shipping_Method')) {
    class WC_LP_Express_Courrier_Shipping_Method extends WC_Shipping_Method
    {
        /**
         * Adds LP Express courrier shipping to WooCommerce shipping settings
         * WC_LP_Express_Courrier_Shipping_Method constructor.
         */
        public function __construct()
        {
            $this->id               = 'lp_express_courrier_shipping_method';
            $this->method_title     = __('LP Express pristatymas kurjeriu', 'lp_express');
        ...
        /**
         * Adds form fields to WooCommerce LP Express courrier shipping settings
         */
        public function init_form_fields()
        {
            $this->form_fields = [
                'enabled'           => [
                    ...
                    'type'          => 'checkbox',
                    'label'         => __('Įjungti LP Express pristatymą kurjeriu', 'lp_express'),
                    'default'       => 'no'
                ],
                'title'             => [
                    'title'         => __('Būdo pavadinimas', 'lp_express'),
                    'type'          => 'text',
                    'description'   => __('Tai kontroliuoja pavadinima kurį matys lankytojas čekio puslapyje ', 'lp_express'),
                    'default'       => __('LP Express pristatymas kurjeriu', 'lp_express'),
                ]
            ];
        }
        ...
        public function is_available($package)
        {
            ...
            if (WC()->customer->get_shipping_country() == "LT") {
                ...
                return Woocommerce_Lp_Express_Public::send_request('EB', $weight, $package);
            }
        ...
        /**
         * Get current method shipping price
         * @return mixed
         */
        public function get_fixed_price()
        {
            return get_option('wc_lp_express_sender_settings')['wp_lp_fixed_courier'];
        }
        ...
        public function calculate_shipping($package = array())
        {
            if ($this->get_fixed_price() == null) {
                ...
                Woocommerce_Lp_Express_Public::send_request('EB', $weight, $package, $cost);
